...
use crate::{xingxiang::game::XingxiangGame, tree::game_tree_event::{DeleteVariationEvent, MoveToNodeEvent}, ui::ui_menu::*};

pub fn ui_game_tree_xingxiang(
    ...
    egui::Window::new("Game Tree")
        ...
        .show(ctx, |ui| {
            egui::ScrollArea::vertical()
                .max_height(400.0)
                .show(ui, |ui| {
                    xingxiang.tree.display_egui(ui, &mut ew_mtn, &mut ew_dv);
                });
            ...
            egui::TopBottomPanel::bottom("button_panel")
                .show_inside(ui, |ui| {
                    ...
                    let is_first_board = xingxiang.tree.is_first_board();
                    let is_last_board = xingxiang.tree.is_last_board();
                    ...
                    Grid::new("navigation_buttons")
                        ...
                        .show(ui, |ui| {
                            ...
                            if response.clicked() {
                                xingxiang.tree.move_backward(&mut ew_mtn);
                            }
                            ...
                            if response.clicked() {
                                xingxiang.tree.move_forward(&mut ew_mtn);
                            }
                            ...
                            if response.clicked() {
                                xingxiang.tree.move_to_end(&mut ew_mtn);
                            }
                        });
                });
        });
